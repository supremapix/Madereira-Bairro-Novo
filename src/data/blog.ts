...
Para obras provisórias ou ambientes internos secos, o Pinus comum é imbatível no preço. Para áreas externas e estruturas definitivas expostas ao clima de Curitiba, o Pinus Tratado é indispensável.
  ...
  },
  {
    ...
    excerpt: 'Aprenda o passo a passo para dimensionar a estrutura de madeira da sua cobertura com segurança.',
    content: `
O telhado é uma das etapas mais importantes da edificação. O engradamento precisa suportar o peso próprio das telhas, a ação do vento e eventuais sobrecargas de manutenção.
